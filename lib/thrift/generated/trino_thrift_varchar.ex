defmodule(Thrift.Generated.TrinoThriftVarchar) do
  @moduledoc false
  _ = "Auto-generated Thrift struct TrinoThriftService.TrinoThriftVarchar"
  _ = "1: list<bool> nulls"
  _ = "2: list<i32> sizes"
  _ = "3: binary bytes"
  ...
  defmodule(BinaryProtocol) do
    ...
    def(deserialize(binary)) do
      deserialize(binary, %Thrift.Generated.TrinoThriftVarchar{})
    end

    defp(deserialize(<<0, rest::binary>>, %Thrift.Generated.TrinoThriftVarchar{} = acc)) do
      {acc, rest}
    end
    ...
    def(
      serialize(%Thrift.Generated.TrinoThriftVarchar{nulls: nulls, sizes: sizes, bytes: bytes})
    ) do
      [
        case(nulls) do
          nil ->
