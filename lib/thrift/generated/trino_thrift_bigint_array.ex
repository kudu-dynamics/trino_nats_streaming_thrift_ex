defmodule(Thrift.Generated.TrinoThriftBigintArray) do
  @moduledoc false
  _ = "Auto-generated Thrift struct TrinoThriftService.TrinoThriftBigintArray"
  _ = "1: list<bool> nulls"
  _ = "2: list<i32> sizes"
  _ = "3: TrinoThriftService.TrinoThriftBigint values"
  defstruct(nulls: nil, sizes: nil, values: nil)
  @type t :: %__MODULE__{}
  def(new) do
    %__MODULE__{}
  end
  ...
  defmodule(BinaryProtocol) do
    ...
    def(deserialize(binary)) do
      deserialize(binary, %Thrift.Generated.TrinoThriftBigintArray{})
    end

    defp(deserialize(<<0, rest::binary>>, %Thrift.Generated.TrinoThriftBigintArray{} = acc)) do
      {acc, rest}
    end
    ...
    defp(deserialize(<<12, 3::16-signed, rest::binary>>, acc)) do
      case(Thrift.Generated.TrinoThriftBigint.BinaryProtocol.deserialize(rest)) do
        {value, rest} ->
          deserialize(rest, %{acc | values: value})
    ...
    def(
      serialize(%Thrift.Generated.TrinoThriftBigintArray{
        nulls: nulls,
        sizes: sizes,
        values: values
      })
      ...
      [
        ...
        case(values) do
          ...
          _ ->
            [<<12, 3::16-signed>> | Thrift.Generated.TrinoThriftBigint.serialize(values)]
        end
        | <<0>>
      ]
    end
