defmodule(Thrift.Generated.TrinoThriftJson) do
  @moduledoc false
  _ = "Auto-generated Thrift struct TrinoThriftService.TrinoThriftJson"
  _ = "1: list<bool> nulls"
  _ = "2: list<i32> sizes"
  _ = "3: binary bytes"
  ...
  defmodule(BinaryProtocol) do
    ...
    def(deserialize(binary)) do
      deserialize(binary, %Thrift.Generated.TrinoThriftJson{})
    end

    defp(deserialize(<<0, rest::binary>>, %Thrift.Generated.TrinoThriftJson{} = acc)) do
      {acc, rest}
    end
    ...
    def(serialize(%Thrift.Generated.TrinoThriftJson{nulls: nulls, sizes: sizes, bytes: bytes})) do
      [
        case(nulls) do
          nil ->
            <<>>
